...
module.exports = function (crypto) {
   ...
   */
  output.encrypt = function (object, password, { algorithm = 'aes-256-cbc', encoding = 'hex', keys = [] } = {}) {
   ...
   */
  output.decrypt = function (object, password, { algorithm = 'aes-256-cbc', encoding = 'hex', keys = [] } = {}) {
    if (!object || typeof object !== 'object' || Array.isArray(object)) {
      throw new Error('First argument must be an object.')
    }
